...
export const styles = stylex.create({
  ...
  directory: { listStyle: "none", minWidth: 0 },
  directoryButton: { alignItems: "center", backgroundColor: "transparent", borderWidth: 0, color: "#625d55", cursor: "pointer", display: "grid", fontFamily: '"SFMono-Regular", Consolas, monospace', fontSize: 11, fontWeight: 700, gap: 5, gridTemplateColumns: "14px minmax(0, 1fr) auto", paddingBlock: 6, paddingInline: 8, textAlign: "left", width: "100%" },
  chevron: { color: "#8b8378", textAlign: "center" },
  directoryCount: { color: "#999187", fontSize: 9, fontWeight: 500 },
  treeGroup: { listStyle: "none", margin: 0, paddingInlineStart: 13 },
  ...
  symbolButton: { backgroundColor: "transparent", borderWidth: 0, color: "#625d55", cursor: "pointer", display: "grid", fontFamily: '"SFMono-Regular", Consolas, monospace', fontSize: 11, gap: 4, gridTemplateColumns: "52px minmax(0, 1fr) auto", paddingBlock: 5, paddingInline: 5, textAlign: "left", textDecoration: "none", width: "100%" },
  ...
  code: { backgroundColor: "#ffffff", color: ink, fontFamily: '"SFMono-Regular", Consolas, "Liberation Mono", monospace', fontSize: 12, lineHeight: 1.65, margin: 0, minHeight: "calc(100% - 80px)", overflow: "auto", paddingBlock: 18 },
  codeDark: { backgroundColor: "#0d1117", color: "#e6edf3" },
  ...
  definition: { borderBottomColor: "currentColor", borderBottomStyle: "dotted", borderBottomWidth: 1, cursor: "pointer", textDecoration: "none" },
